      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-center">
        <div className="flex-1 flex flex-col items-center gap-1">
          ...
          <p className="text-[20px] font-bold text-gray-900 leading-none">
            {kwp ?? '—'} <span className="text-[12px] text-gray-400 font-semibold">kWp</span>
          </p>
          <p className="text-[11px] text-gray-400 font-medium">Sistemos galia</p>
        </div>
        <div className="w-px self-stretch bg-gray-100 mx-1" />
        <div className="flex-1 flex flex-col items-center gap-1">
          <Battery size={18} className="text-gray-400" />
          <p className="text-[20px] font-bold text-gray-900 leading-none">
            {kwh != null ? kwh : '—'} <span className="text-[12px] text-gray-400 font-semibold">kWh</span>
          </p>
          <p className="text-[11px] text-gray-400 font-medium">Baterija</p>
        </div>
      </div>

      {/* ── Equipment list ── */}
      <div>
        <h3 className="text-[12px] font-bold text-gray-400 uppercase tracking-wider mb-2 px-1">Komplektacija</h3>
        {items.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-gray-900 text-[14px] truncate">{item.model || '—'}</p>
                  ...
                  <span className="text-[13px] font-semibold text-gray-500 whitespace-nowrap shrink-0">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm py-10 flex flex-col items-center gap-2">
            ...
            <p className="text-[14px] text-gray-400">Įrangos informacijos dar nėra.</p>
          </div>
        )}
      </div>
    </div>
