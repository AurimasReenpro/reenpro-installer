...
const STATUS: Record<string, { label: string; cls: string; live?: boolean }> = {
  pending:     { label: 'Laukia',      cls: 'bg-gray-50 text-gray-600 border-gray-200' },
...
const chip = 'inline-flex items-center gap-1.5 bg-gray-100/80 text-gray-700 px-3 py-1.5 rounded-lg text-[13px] font-medium';
...
export default function HeroSection({ clientName, address, status, teamName }: HeroSectionProps) {
  ...
  return (
    ...
    <div className="bg-white px-4 pb-3 mt-[56px] border-b border-gray-100">
      {/* Large title + status */}
      <div className="flex justify-between items-center gap-4 mt-2">
        <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight truncate min-w-0">
